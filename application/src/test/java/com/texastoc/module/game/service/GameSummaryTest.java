...
public class GameSummaryTest {
  ...
  public void testGameSummary() throws IOException {
    ...
    season.setQuarterlySeasons(quarterlySeasons);
    ...
    Mockito.verify(notificationModule, times(1)).sendEmail(emailsArg.capture(), subjectArg.capture(), bodyArg.capture());
    ...
    Assertions.assertThat(emails).containsExactlyInAnyOrder("good-one@texastoc.com", "another-good-one@texastoc.com");
  }
